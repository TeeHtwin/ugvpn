...
class LanguageHi extends BaseLanguage {
  @override
  String get lblYouAreConnectedTo => "आप से जुड़े हुए हैं";

  @override
  String get lblGettingIP => "आईपी ​​प्राप्त करना ...";

  @override
  String get lblConnect => "जुडिये";

  @override
  String get lblVersion => "संस्करण";

  @override
  String get lblVPNConnect => "वीपीएन कनेक्ट";

  @override
  String get lblInternetSpeed => "इंटरनेट की गति";

  @override
  String get lblSetting => "स्थापना";

  @override
  String get lblVpnStarted => "वीपीएन शुरू हुआ";

  @override
  String get lblDisconnect => "डिस्कनेक्ट";

  @override
  String get lblWouldYouLikeToCancelTheCurrentVPNConnection => "क्या आप वर्तमान वीपीएन कनेक्शन को रद्द करना चाहते हैं?";

  @override
  String get lblYourVPNConnectionHasBeenDisconnected => "आपका वीपीएन कनेक्शन डिस्कनेक्ट हो गया है";
  ...
  @override
  String get lblPleaseWaitWhileReconnecting => "कृपया पुनः कनेक्ट करते समय प्रतीक्षा करें";
  ...
  @override
  String get lblDownloadTestFailed => "डाउनलोड परीक्षण विफल! कृपया अपने इंटरनेट कनेक्शन की जाँच करें";

  @override
  String get lblStartTestAgain => "फिर से परीक्षण शुरू करें";

  @override
  String get lblUploadTestFailed => "अपलोड परीक्षण विफल! कृपया अपने इंटरनेट कनेक्शन की जाँच करें";
  ...
  @override
  String get lblCancelSubscriptionMsg => "आप Google Play Store से सदस्यता रद्द कर सकते हैं";
